...
## 4.1 **路径映射**
 ...
 ![](./assets/Zuul-路径映射.png)

 

 

## 4.2 Zuul整合Swagger，使用ZuulFilter解决下游服务context-path

[Zuul整合Swagger，使用ZuulFilter解决下游服务context-path](https://www.cnblogs.com/dalaoyang/p/12005283.html)

![](./assets/Zuul-整合swagger.png)
